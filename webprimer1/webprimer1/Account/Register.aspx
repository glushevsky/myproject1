<%@ Page Title="Регистрация" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="webprimer1.Account.Register" %>
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Длина пароля не должна быть меньше <%= Membership.MinRequiredPasswordLength %> знаков.
                    </p>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="EmailRequired" runat="server" ControlToValidate="Email" 
                                     CssClass="failureNotification" ErrorMessage="Поле ''Электронная почта'' является обязательным." ToolTip="Поле ''Электронная почта'' является обязательным." 
                                     ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                            </p>
                            <p>
